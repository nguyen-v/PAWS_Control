...
axs[len(speeds)].plot(periods_crop, difference_synergy1, color='blue', label='Difference Synergy 1')
axs[len(speeds)].plot(periods_crop, difference_synergy2, color='green', label='Difference Synergy 2')
