...
file_paths = {
    ...
    3: ['PASSIVE_LONGER_NEWTENDONS_3KMH.csv', 'PASSIVE_3KMH_NEW_TENDONS2.csv'],
}
speeds = [1, 1.5, 2, 2.5, 3]  # Corresponding speeds in km/h
...
for idx, speed in enumerate(speeds):
    ...
    axs.plot(periods_crop, avg_data1_crop, color='red', linewidth=4, alpha = idx*0.2 + 0.2)
    axs.plot(periods_crop, avg_data2_crop, color='gray', linewidth=4, alpha = idx*0.2 + 0.2)
