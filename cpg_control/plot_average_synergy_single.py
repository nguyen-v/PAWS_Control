...
PERIOD_OFFSET = 0.26  # Offset in seconds before and after foot contact
...
for idx, speed in enumerate(speeds):
    ...
    axs.plot(periods_crop, avg_data1_crop, color='red', linewidth=4, alpha = 1)
    axs.plot(periods_crop, avg_data2_crop, color='gray', linewidth=4, alpha = 1)
    axs.set_title(f'Treadmill speed {speed} km/h', fontsize=14)
    axs.plot(periods_crop, avg_data1_crop, color='red', label='Average Synergy 1')
    axs.plot(periods_crop, avg_data2_crop, color='gray', label='Average Synergy 2')
